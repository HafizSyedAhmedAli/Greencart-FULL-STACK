    ...
    return (
        <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all z-10">
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                {!user ? (
                    <button className="cursor-pointer px-8 py-2 bg-primary hover:bg-primary-dull transition text-white rounded-full" onClick={() => setShowUserLogin
                        (true)
                    }>
                        Login
                    </button>
                    ...
                    <div className='relative group'>
                        <img className='w-8 rounded-full' src={assets.profile_icon} alt="" />
                        <ul className='hidden group-hover:block absolute top-full right-0 bg-white shadow border border-gray-200 py-2.5 w-30 rounded-md text-sm z-40'>
