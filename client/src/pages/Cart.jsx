...
const Cart = () => {
    ...
    const placeOrder = async () => {
        try {
            if (!selectedAddress) return toast.error("Pls select an address");
    ...
    return products.length && cartItems ? (
        <div className="flex flex-col md:flex-row mt-16">
                                ...
                                <div className="font-normal text-gray-500/70">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <select className="outline-none"
                                            onChange={(e) => updateCartItem(product._id, Number.parseInt(e.target.value))}
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <button className="w-full py-3 mt-6 cursor-pointer bg-primary text-white font-medium hover:bg-primary-dull transition" onClick={placeOrder}>
